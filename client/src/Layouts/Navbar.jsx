        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            {!userInfo ? (
              ...
              <>
                <button
                  className="relative inline-flex items-center p-2 text-sm font-medium text-center text-gray-900 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none"
